...
declare global {
  namespace NodeJS {
    interface ProcessEnv {
      ...
      // xiaomimimo only
      XIAOMIMIMO_URL?: string;
      XIAOMIMIMO_API_KEY?: string;
...
export const getServerSideConfig = () => {
  ...
  const isXiaomiMiMo = !!process.env.XIAOMIMIMO_API_KEY;
  ...
  return {
    ...
    isXiaomiMiMo,
    xiaomimimoUrl: process.env.XIAOMIMIMO_URL,
    xiaomimimoApiKey: getApiKey(process.env.XIAOMIMIMO_API_KEY),
