...
const DEFAULT_XIAOMIMIMO_URL = isApp ? XIAOMIMIMO_BASE_URL : ApiPath.XiaomiMiMo;
...
const DEFAULT_ACCESS_STATE = {
  ...
  // xiaomimimo
  xiaomimimoUrl: DEFAULT_XIAOMIMIMO_URL,
  xiaomimimoApiKey: "",
...
export const useAccessStore = createPersistStore(
  ...
  (set, get) => ({
    ...
    isValidXiaomiMiMo() {
      return ensure(get(), ["xiaomimimoApiKey"]);
    },
