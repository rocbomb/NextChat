  ...
  Settings: {
    ...
    Sync: {
      ...
      Overview: (overview: any) => {
        return `${overview.chat} 次对话，${overview.message} 条消息，${overview.prompt} 条提示词，${overview.mask} 个智能助手`;
      },
      ImportFailed: "导入失败",
    },
    Mask: {
      Splash: {
        Title: "智能助手启动页",
        SubTitle: "新建聊天时，展示智能助手启动页",
      },
      Builtin: {
        Title: "隐藏内置智能助手",
        SubTitle: "在所有智能助手列表中隐藏内置智能助手",
      },
    },
    Prompt: {
      Disable: {
